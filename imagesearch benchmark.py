...
REGION = (1000, 500, 200, 200)
GAME_OVER_PICTURE_PIL = Image.open('image/reel.png')
GAME_OVER_PICTURE_CV = cv.imread('image/reel.png')
...
def benchmark_pyautogui():
    res = pg.locateOnScreen(GAME_OVER_PICTURE_PIL,
                            grayscale=False,  # should provied a speed up
                            confidence=0.8,
                            region=REGION)
